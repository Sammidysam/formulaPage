...
\fbox{\begin{minipage}{216pt}
    ...
    When degree of numerator is more than one greater than degree of denominator
    \begin{align*}
    ...
    If degree of denominator is greater, 0
\end{minipage}}
\fbox{\begin{minipage}{212pt}
    \centering Slant Asymptotes
    
    When degree of numerator is one greater than degree of denominator
    \begin{align*}
...
\fbox{\begin{minipage}{183pt}
    \centering $y=\tan x$ in red; $y=\cot x$ in blue, asymtotes dotted
    
    \begin{tikzpicture}[trim axis left,trim axis right]
      \begin{axis}[domain=0:pi,xmin=-0.5,xmax=3.64159,ymin=-20,ymax=20,restrict y to domain=-20:20,width=194pt,height=120pt,xtick={0,0.7853975,1.570795,2.3561925,3.14159},xticklabels={0,$\pi/4$,$\pi/2$,$3\pi/4$,$\pi$}]
        \addplot[smooth,red,samples=301] plot (\x, {tan(\x r)});
        \addplot[smooth,blue,samples=301] plot (\x, {1/tan(\x r)});
        \draw[blue,dotted] (axis cs:0,-20) -- (axis cs:0,20);
        \draw[red,dotted] (axis cs:1.570795,-20) -- (axis cs:1.570795,20);
        \draw[blue,dotted] (axis cs:3.14159,-20) -- (axis cs:3.14159,20);
      \end{axis}

    \end{tikzpicture}
\end{minipage}}
\fbox{ \begin{minipage}{140pt}
    \centering tan/cot Graph Properties

    \raggedright If in form:
    \[
    y=a\sin k(x-b)
    \]
    amplitude  $|a|$, period  $\pi/k$, phase shift $b$
\end{minipage}}
\end{document}
